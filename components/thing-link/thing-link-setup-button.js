...
const ThingLinkSetupButton = ({ data, onUpdatePosition, containerRef }) => {
    ...
    return (
        <motion.div
            ...
            className={`origin-center cursor-pointer absolute bg-red-500 bg-opacity-20 rounded-full -top-4 -left-4 w-8 h-8 ${data.className} flex justify-center items-center z-50 shadow-2xl border-white border`}
            drag
